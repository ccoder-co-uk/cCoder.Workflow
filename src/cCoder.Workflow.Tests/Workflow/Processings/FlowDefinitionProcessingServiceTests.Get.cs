...
public partial class FlowDefinitionProcessingServiceTests
{
    ...
    public void ShouldDelegateToFoundationServiceWhenGet()
    {
        ...
        var id = entity.Id;
        flowDefinitionServiceMock.Setup(expression: x => x.Get(id: id)).Returns(value: entity);
        ...
        flowDefinitionServiceMock.Verify(expression: x => x.Get(id: id), times: Times.Once);
