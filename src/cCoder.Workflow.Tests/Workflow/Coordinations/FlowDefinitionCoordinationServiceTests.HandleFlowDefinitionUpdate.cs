...
{
    [Fact]
    public async Task ShouldAddOrUpdateChildInstancesWhenHandleFlowDefinitionUpdate()
    {
        // Given
        ...
        // When
        await coordinationService.HandleFlowDefinitionUpdateAsync(flowDefinition);
