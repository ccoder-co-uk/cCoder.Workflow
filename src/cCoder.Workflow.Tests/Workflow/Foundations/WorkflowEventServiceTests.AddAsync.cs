...
public partial class WorkflowEventServiceTests
{
    ...
    public async Task ShouldDelegateToBrokerWhenUserIsAuthorizedForAddAsync()
    {
        ...
        authorizationBrokerMock.Setup(expression:x => x.Authorize((int?)7, "WorkflowEvent_create"));
...
expression:            x => x.Authorize((int?)7, "WorkflowEvent_create"),
times:            Times.Once
        );
    }
    ...
    public async Task ShouldThrowSecurityExceptionWhenUserLacksCreatePrivilegeForAddAsync()
    {
        ...
        authorizationBrokerMock
            .Setup(expression:x => x.Authorize((int?)7, "WorkflowEvent_create"))
